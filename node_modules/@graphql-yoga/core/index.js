    ...
    constructor(options) {
        ...
        this.getEnveloped = core.envelop({
            plugins: [
                ...
                core.useExtendContext(() => ({ logger: this.logger })),
                // Log events - useful for debugging purposes
                core.enableIf(this.isDev, core.useLogger({
                ...
                core.enableIf(!this.isDev, disableIntrospection.useDisableIntrospection()),
                // Mask errors in production
                core.enableIf(!this.isDev, core.useMaskedErrors()),
...
const GraphQLBlob = new graphql.GraphQLScalarType({
    name: 'Blob',
...
exports.BaseGraphQLServer = BaseGraphQLServer;
exports.GraphQLBlob = GraphQLBlob;
